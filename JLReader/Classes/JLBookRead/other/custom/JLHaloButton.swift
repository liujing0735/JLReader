...
class JLHaloButton: UIControl {
    ...
    class func HaloButtonSize(_ size:CGSize) ->CGSize {
        ...
        return CGSize(width: size.width + JLSpace_5, height: size.height + JLSpace_5)
    }
    ...
    private func setFrame() {
        ...
        // 布局
        imageView.frame = CGRect(x: JLSpace_4, y: JLSpace_4, width: width - JLSpace_5, height: height - JLSpace_5)
        
        // 圆角
        imageView.layer.cornerRadius = (width - JLSpace_5) / 2
    }
