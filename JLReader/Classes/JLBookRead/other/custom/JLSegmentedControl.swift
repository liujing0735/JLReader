//
//  JLSegmentedControl.swift
//  JLReader
//
//  Created by JasonLiu on 2018/3/24.
//  Copyright © 2018年 JasonLiu. All rights reserved.
//

import UIKit

@objc protocol JLSegmentedControlDelegate:NSObjectProtocol {
    
    /// 点击按钮
    @objc optional func segmentedControl(segmentedControl:JLSegmentedControl, clickButton button:UIButton, index:NSInteger)
}

class JLSegmentedControl: UIView {
    
    /// 代理
    weak var delegate:JLSegmentedControlDelegate?
    ...
    init(_ delegate:JLSegmentedControlDelegate? = nil) {
    ...
    private func addSubviews() {
        ...
        for i in 0..<count {
            ...
            button.addTarget(self, action: #selector(JLSegmentedControl.clickButton(button:)), for: .touchDown)
