...
#import "JLCoverController.h"

@interface JLCoverController ()<UIGestureRecognizerDelegate>
...
@implementation JLCoverController
    ...
    if (self.pendingController) {
        ...
        if (self.isLeft) { // 左边
            ...
            if (animated) {
                ...
                __weak JLCoverController *weakSelf = self;
