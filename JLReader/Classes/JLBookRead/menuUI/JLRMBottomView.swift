...
class JLRMBottomView: JLRMBaseView,ASValueTrackingSliderDelegate {
    ...
    override func addSubviews() {
        ...
        previousChapter.titleLabel?.font = JLFont_12
        ...
        nextChapter.titleLabel?.font = JLFont_12
    ...
    override func layoutSubviews() {
        ...
        // 上一章
        previousChapter.frame = CGRect(x: 0, y: JLSpace_4, width: 55, height: 32)
        
        // 下一章
        nextChapter.frame = CGRect(x: width - previousChapter.width, y: JLSpace_4, width: previousChapter.width, height: previousChapter.height)
        
        // 进度条
        let sliderX = previousChapter.frame.maxX + JLSpace_4
        let sliderW:CGFloat = width - 2 * sliderX
        slider.frame = CGRect(x: sliderX, y: JLSpace_4, width: sliderW, height: previousChapter.height)
